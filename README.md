...
| autoAck         | false            | Acknowledge on receipt or after processing.  autoAck=true is 30-50% faster in tests but can cause message loss in cases where UnbundedSolaceReader needs to
re-establish connection to Solace such as auto-scaling event or network outages|
